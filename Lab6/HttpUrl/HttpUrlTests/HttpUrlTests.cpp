// HttpUrlTests.cpp : Defines the entry point for the console application.
//
...
BOOST_AUTO_TEST_SUITE(after_initializing)
	...
	BOOST_AUTO_TEST_CASE(can_get_each_part_of_url)
	{
		...
		CHttpUrl url2("katewinslet.com", "/cats", HTTPS, 666);
		BOOST_CHECK(url2.GetProtocol() != HTTP);
	...
	BOOST_AUTO_TEST_CASE(adds_forward_slash_if_document_havent_it)
	{
		...
		CHttpUrl url3("katewinslet.com", "/cats", HTTPS, 666);
