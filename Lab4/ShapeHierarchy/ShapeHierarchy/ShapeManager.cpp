...
void CShapeManager::LoadShapeCreators()
{
	m_shapeCreators.emplace("Circle", std::bind(&CShapeManager::CreateCircle, this, std::placeholders::_1));
	m_shapeCreators.emplace("Rectangle", std::bind(&CShapeManager::CreateRectangle, this, std::placeholders::_1));
	m_shapeCreators.emplace("Triangle", std::bind(&CShapeManager::CreateTriangle, this, std::placeholders::_1));
	m_shapeCreators.emplace("Line", std::bind(&CShapeManager::CreateLine, this, std::placeholders::_1));
}


std::shared_ptr<IShape> CShapeManager::CreateShape(std::vector<std::string> const& shapeInfo)
{
	return m_shapeCreators.at(shapeInfo[0])(shapeInfo);
}

std::shared_ptr<IShape> CShapeManager::CreateCircle(std::vector<std::string> const& shapeInfo)
{
...
std::shared_ptr<IShape> CShapeManager::CreateTriangle(std::vector<std::string> const& shapeInfo)
{
...
std::shared_ptr<IShape> CShapeManager::CreateLine(std::vector<std::string> const& shapeInfo)
{
	vector<string> first;
...
std::shared_ptr<IShape> CShapeManager::CreateRectangle(std::vector<std::string> const& shapeInfo)
{
	vector<string> pos;
